#include <math.h>
float Roll = 0;        /*!< Roll angle value. This parameter is in units of degrees */
float Pitch = 0;       /*!< Pitch angle value. This parameter is in units of degrees */
float Yaw = 0;         /*!< Yaw angle value. This parameter is in units of degrees */
float Inclination = 0; /*!< Inclination in units of degrees */
